          ...
          <div class="card mt-4">
            <div class="card-body p-4 text-center">
              <div class="avatar-lg mx-auto mt-2">
                <div class="avatar-title bg-light text-success display-3 rounded">
              ...
              <div class="mt-4 pt-2">
                ...
                <div class="mt-4">
                  <a href="<?php echo $site->buttom_ref ?>" class="btn btn-info"><i class="bx bx-recycle me-1"></i><?php echo $site->buttom_text ?></a>
                </div>
              </div>
            </div>
          </div>
